...
from NLR_utils import umeyama_alignment, prepare_data, get_normalize_u
from itertools import chain

def results_filter(args):
    file_name = os.path.join(args.path_results, "test_filter.p")
    ...
    u_loc, u_std = get_normalize_u(args)
    u_normalized = (u - u_loc.numpy()) / u_std.numpy()
    ...
    for l, fig in enumerate(figs):
        ...
        fig.savefig(os.path.join(args.path_results, fig_name + ".png"))
